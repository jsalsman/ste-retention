...
def chat(
    ...
    *,
    ...
    """Send one chat request and validate its text and completion metadata."""
    if not api_key:
    ...
    try:
        ...
        if normalized_reason in TRUNCATION_FINISH_REASONS:
            # Preserve useful partial text without exposing the provider response body.
            raise IncompleteGenerationError(content, normalized_reason)
